...
var $;
(function ($) {
    class $milis_snake_person_crus extends $hyoo_crus_home.with({
    ...
    $.$milis_snake_person_crus = $milis_snake_person_crus;
})($ || ($ = {}));
...
;
	($.$mol_icon_arrow_down_bold) = class $mol_icon_arrow_down_bold extends ($.$mol_icon) {
		path(){
...
;
	($.$milis_snake_app) = class $milis_snake_app extends ($.$mol_page) {
		Player_keyboard(){
			const obj = new this.$.$mol_hotkey();
			(obj.key) = () => ({
				"A": (next) => (this.left(next)), 
				"left": (next) => (this.left(next)), 
				"D": (next) => (this.right(next)), 
				"right": (next) => (this.right(next)), 
				"S": (next) => (this.down(next)), 
				"down": (next) => (this.down(next)), 
				"W": (next) => (this.top(next)), 
				"up": (next) => (this.top(next))
			});
			return obj;
		}
		Status(){
		...
		Keyboard(){
			const obj = new this.$.$milis_snake_app_keyboard();
			(obj.left) = (next) => ((this.left()));
			(obj.right) = (next) => ((this.right()));
			(obj.top) = (next) => ((this.top()));
			(obj.down) = () => ((this.down()));
			return obj;
		}
		cell_title(id){
		...
		is_cell_snake_head(id){
			return false;
		}
		Cell(id){
			const obj = new this.$.$milis_snake_app_cell();
			(obj.cell_title) = () => ((this.cell_title(id)));
			(obj.is_cell_food) = () => ((this.is_cell_food(id)));
			(obj.is_cell_snake) = () => ((this.is_cell_snake(id)));
			(obj.is_cell_snake_head) = () => ((this.is_cell_snake_head(id)));
			return obj;
		}
		x_list(id){
			return [(this.Cell("0_0"))];
		}
		X(id){
		...
		person(){
			const obj = new this.$.$milis_snake_person_crus();
			return obj;
		}
		plugins(){
			return [(this.Player_keyboard())];
		}
		foot(){
			return [(this.Status())];
		}
	...
	($mol_mem(($.$milis_snake_app.prototype), "top"));
	($mol_mem(($.$milis_snake_app.prototype), "down"));
	($mol_mem(($.$milis_snake_app.prototype), "Keyboard"));
	...
	($.$milis_snake_app_cell) = class $milis_snake_app_cell extends ($.$mol_button_major) {
		...
		attr(){
			return {
				...(super.attr()), 
				"food": (this.is_cell_food()), 
				"snake": (this.is_cell_snake()), 
				"head": (this.is_cell_snake_head())
			};
		}
	};
	($.$milis_snake_app_keyboard) = class $milis_snake_app_keyboard extends ($.$mol_row) {
		Left_icon(){
			const obj = new this.$.$mol_icon_arrow_left_bold();
			return obj;
		}
		left(next){
			if(next !== undefined) return next;
		...
		Down(){
			...
			(obj.click) = (next) => ((this.down(next)));
			return obj;
		}
		Vertical(){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ([(this.Top()), (this.Down())]);
			return obj;
		}
		Right_icon(){
	...
	($mol_mem(($.$milis_snake_app_keyboard.prototype), "Left_icon"));
	($mol_mem(($.$milis_snake_app_keyboard.prototype), "left"));
	($mol_mem(($.$milis_snake_app_keyboard.prototype), "Left"));
	($mol_mem(($.$milis_snake_app_keyboard.prototype), "Top_icon"));
	($mol_mem(($.$milis_snake_app_keyboard.prototype), "top"));
	($mol_mem(($.$milis_snake_app_keyboard.prototype), "Top"));
	($mol_mem(($.$milis_snake_app_keyboard.prototype), "Down_icon"));
	($mol_mem(($.$milis_snake_app_keyboard.prototype), "down"));
	($mol_mem(($.$milis_snake_app_keyboard.prototype), "Down"));
	($mol_mem(($.$milis_snake_app_keyboard.prototype), "Vertical"));
	($mol_mem(($.$milis_snake_app_keyboard.prototype), "Right_icon"));
	($mol_mem(($.$milis_snake_app_keyboard.prototype), "right"));
	($mol_mem(($.$milis_snake_app_keyboard.prototype), "Right"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $milis_snake_app.prototype, "person", null);
        __decorate([
            $mol_mem
        ], $milis_snake_app.prototype, "food", null);
        __decorate([
            $mol_mem
        ], $milis_snake_app.prototype, "snake", null);
        __decorate([
            $mol_mem
        ], $milis_snake_app.prototype, "y_list", null);
        $$.$milis_snake_app = $milis_snake_app;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
