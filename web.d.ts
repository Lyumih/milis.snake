...
declare namespace $ {
    ...
    class $hyoo_crus_sand extends $hyoo_crus_unit {
        ...
        dump(): {
            ...
            head: string;
            self: string;
            tip: "time" | "ref" | "json" | "nil" | "bin" | "bool" | "int" | "real" | "ints" | "reals" | "str" | "dur" | "range" | "jsan" | "dom" | "tree";
...
declare namespace $ {
    const $milis_snake_person_crus_base: Omit<typeof $hyoo_crus_home, "prototype"> & (new (...args: any[]) => $mol_type_override<$hyoo_crus_home, {
        ...
        readonly Max_x: (auto?: any) => $hyoo_crus_atom_real | null;
        readonly Max_y: (auto?: any) => $hyoo_crus_atom_real | null;
        readonly Death_count: (auto?: any) => $hyoo_crus_atom_real | null;
    }>) & {
        schema: {
            [x: string]: typeof $hyoo_crus_node;
        } & {
            readonly Score: typeof $hyoo_crus_atom_real;
            readonly Max_score: typeof $hyoo_crus_atom_real;
            readonly Max_x: typeof $hyoo_crus_atom_real;
            readonly Max_y: typeof $hyoo_crus_atom_real;
            readonly Death_count: typeof $hyoo_crus_atom_real;
        };
    };
    export class $milis_snake_person_crus extends $milis_snake_person_crus_base {
        max_score(next?: number): number;
        score(next?: number): number;
        score_up(): void;
        max_x(next?: number): number;
        max_y(next?: number): number;
        death_count(next?: number): number;
        death_count_up(): void;
        win(): void;
    }
    export {};
...
declare namespace $ {
	...
	type $mol_hotkey__key_milis_snake_app_1 = $mol_type_enforce<
		({ 
			A( next?: ReturnType< $milis_snake_app['left'] > ): ReturnType< $milis_snake_app['left'] >,
			left( next?: ReturnType< $milis_snake_app['left'] > ): ReturnType< $milis_snake_app['left'] >,
			D( next?: ReturnType< $milis_snake_app['right'] > ): ReturnType< $milis_snake_app['right'] >,
			right( next?: ReturnType< $milis_snake_app['right'] > ): ReturnType< $milis_snake_app['right'] >,
			S( next?: ReturnType< $milis_snake_app['down'] > ): ReturnType< $milis_snake_app['down'] >,
			down( next?: ReturnType< $milis_snake_app['down'] > ): ReturnType< $milis_snake_app['down'] >,
			W( next?: ReturnType< $milis_snake_app['top'] > ): ReturnType< $milis_snake_app['top'] >,
			up( next?: ReturnType< $milis_snake_app['top'] > ): ReturnType< $milis_snake_app['top'] >,
		}) 
		,
		ReturnType< $mol_hotkey['key'] >
	>
	...
	export class $milis_snake_app extends $mol_page {
		...
		is_cell_food( id: any): boolean
		is_cell_snake( id: any): boolean
		is_cell_snake_head( id: any): boolean
		Cell( id: any): $milis_snake_app_cell
	...
	export class $milis_snake_app_cell extends $mol_button_major {
		cell_title( ): string
		is_cell_food( ): boolean
		is_cell_snake( ): boolean
		is_cell_snake_head( ): boolean
		title( ): ReturnType< $milis_snake_app_cell['cell_title'] >
		attr( ): ({ 
			'food': ReturnType< $milis_snake_app_cell['is_cell_food'] >,
			'snake': ReturnType< $milis_snake_app_cell['is_cell_snake'] >,
			'head': ReturnType< $milis_snake_app_cell['is_cell_snake_head'] >,
		})  & ReturnType< $mol_button_major['attr'] >
	}
	
	type $mol_button_major__sub_milis_snake_app_keyboard_1 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_major['sub'] >
	>
	type $mol_button_major__click_milis_snake_app_keyboard_2 = $mol_type_enforce<
		ReturnType< $milis_snake_app_keyboard['left'] >
		,
		ReturnType< $mol_button_major['click'] >
	>
	type $mol_button_major__sub_milis_snake_app_keyboard_3 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_major['sub'] >
	>
	type $mol_button_major__click_milis_snake_app_keyboard_4 = $mol_type_enforce<
		ReturnType< $milis_snake_app_keyboard['top'] >
		,
		ReturnType< $mol_button_major['click'] >
	>
	type $mol_button_major__sub_milis_snake_app_keyboard_5 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_major['sub'] >
	>
	type $mol_button_major__click_milis_snake_app_keyboard_6 = $mol_type_enforce<
		ReturnType< $milis_snake_app_keyboard['down'] >
		,
		ReturnType< $mol_button_major['click'] >
	>
	type $mol_list__rows_milis_snake_app_keyboard_7 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_list['rows'] >
	>
	type $mol_button_major__sub_milis_snake_app_keyboard_8 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_button_major['sub'] >
	>
	type $mol_button_major__click_milis_snake_app_keyboard_9 = $mol_type_enforce<
		ReturnType< $milis_snake_app_keyboard['right'] >
		,
		ReturnType< $mol_button_major['click'] >
	>
	export class $milis_snake_app_keyboard extends $mol_row {
		Left_icon( ): $mol_icon_arrow_left_bold
		left( next?: any ): any
		Left( ): $mol_button_major
		Top_icon( ): $mol_icon_arrow_up_bold
		top( next?: any ): any
		Top( ): $mol_button_major
		Down_icon( ): $mol_icon_arrow_down_bold
		down( next?: any ): any
		Down( ): $mol_button_major
		Vertical( ): $mol_list
		Right_icon( ): $mol_icon_arrow_right_bold
		right( next?: any ): any
...
declare namespace $.$$ {
    class $milis_snake_app extends $.$milis_snake_app {
        ...
        y_list(next?: any): $mol_row[];
        x_list(id_y: string): $milis_snake_app_cell[];
        max_x_y(): {
            x: number;
            y: number;
        };
        ...
        cell_title(id_x_y: string): string;
        is_cell_food(id_x_y: string): boolean;
        is_cell_snake(id: string): boolean;
        is_cell_snake_head(id: string): boolean;
        left(next?: any): void;
        right(next?: any): void;
        top(next?: any): void;
        down(next?: any): void;
        ...
        score_text(): string;
        move(direction: 'left' | 'right' | 'top' | 'down'): void;
    }
}
